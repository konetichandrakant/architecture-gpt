...
from schemas.architecture import GetArchitectureRequest, GetArchitectureResponse, UpdateArchitectureRequest
...
class PromptService:
    ...
    def update_architecture(request: PostPromptRequest)->PostPromptResponse:
        ...
        # TODO: send prompt and the existing architecture diagram
